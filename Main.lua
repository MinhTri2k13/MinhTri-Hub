...
Button.Image = "rbxassetid://99068105387603"
...
Tabs.Info:AddButton({
        ...
        Description="Discord",
        Callback=function()
            setclipboard(tostring("https://discord.gg/cCJkJKvF3y")) 
        end
})
Tabs.Info:AddButton({
    Title="Minh Trí Gaming",
    Description="Youtube",
    Callback=function()
        setclipboard(tostring("https://www.youtube.com/@minhtri_gaming"))
    end
})
Tabs.Info:AddButton({
    Title="Nguyên Toàn",
